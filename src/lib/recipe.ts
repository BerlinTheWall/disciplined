import { formatUnit, lineNutrition, scaleNutrition } from "./grocery";
...
export function recipeNutrition(recipe: Recipe, items: Record<string, GroceryItem>): Nutrition {
...
export function perServingNutrition(recipe: Recipe, items: Record<string, GroceryItem>): Nutrition {
...
export function recipeSummary(recipe: Recipe, items: Record<string, GroceryItem>): string {
  const parts: string[] = [];
