...
import { formatTimeRange, minutesToPx, pxToMinutes } from "@/lib/time";
...
function WeeklyPill({ top, durationMinutes, color, icon, completed, onOpen }: WeeklyPillProps) {
...
export default function WeeklyTimeline({ anchorDate }: WeeklyTimelineProps) {
  ...
  const latestEnd = flatItems.reduce(
    (max, item) => {
  ...
  return (
    <>
      ...
      <div className="flex overflow-x-clip gap-2 pt-2">
          ...
          return (
            ...
            >
              ...
              {items.slice(0, -1).map((item, i) => {
                ...
                const topY =
                  scale.mapMinutes(item.startMinutes) + weeklyPillHeight(item.durationMinutes);
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col gap-3">
                      <div className="flex items-center gap-2 text-sm text-fg-faint">
                        ...
                        {detail.streak ? (
                          <span className="flex items-center gap-1 text-[#b5895f] ml-auto font-medium">
                      ...
                      <div className="flex gap-2">
                        <motion.button
                          ...
                          style={{
                            backgroundColor: detail.completed
                              ? "var(--surface-raised)"
                              : detail.color,
