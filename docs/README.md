...
| [TERMS.md](TERMS.md) | Terms of service — **draft**, same caveats |

Elsewhere in the repository:

- [`README.md`](../README.md) — what the app is, how to run it, project status
- [`CONTRIBUTING.md`](../CONTRIBUTING.md) — branch naming, commit format,
  definition of done, how to write tests
- [`SECURITY.md`](../SECURITY.md) — reporting a vulnerability
- [`CHANGELOG.md`](../CHANGELOG.md) — what has changed
- [`backend/README.md`](../backend/README.md) — backend setup, migrations, API
