...
async def _delete_event(db: AsyncSession, user_id: str, args: dict) -> dict:
    ...
    # Local import: outlook_graph/google_calendar import user_timezone from
    # this module, so a top-level import here would be circular.
    from app.services import google_calendar, outlook_graph

    await outlook_graph.maybe_delete_outlook_event(db, user_id, event)
    await google_calendar.maybe_delete_google_event(db, user_id, event)
