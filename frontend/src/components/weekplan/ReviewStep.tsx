...
// The generated draft: a 7-day grid with existing items muted and proposed
// events as removable chips, plus a batch Confirm/Discard footer. Pure
// extraction from the original single-step WeekPlanSheet — no logic change.
export default function ReviewStep() {
  const [busy, message, pendingActions, resolved, error, removeProposal, confirm, discard] =
    useWeekPlanStore(
      useShallow((s) => [
        s.busy,
        s.message,
